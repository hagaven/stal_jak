...
public class Record {
    ...
    @Column(unique = true,nullable = false, name="ident")
    private Long ident;
    @Column(name="pranal",length = 10)
    private String pranal;
    @DateTimeFormat(pattern = "yyyy-MM-dd")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    @Column(name="datai",columnDefinition = "DATETIME")
    @Temporal(TemporalType.TIMESTAMP)
    private Date datai;
    @DateTimeFormat(pattern = "yyyy-MM-dd")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    @Column(name="datao",columnDefinition = "DATETIME")
    @Temporal(TemporalType.TIMESTAMP)
    private Date datao;
    @DateTimeFormat(pattern = "yyyy-MM-dd")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    @Column(name="dataz",columnDefinition = "DATETIME")
    @Temporal(TemporalType.TIMESTAMP)
    private Date dataz;
    @DateTimeFormat(pattern = "yyyy-MM-dd")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    @Column(name="datap",columnDefinition = "DATETIME")
    @Temporal(TemporalType.TIMESTAMP)
    private Date datap;
    @Column(length = 15)
    private String gat;
